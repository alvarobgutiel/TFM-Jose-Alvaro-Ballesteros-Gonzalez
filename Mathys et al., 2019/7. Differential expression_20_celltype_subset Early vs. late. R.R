...
setwd(dir_real)
dir.create("./figures/7.Differential Expression_20_celltypes_early_vs_late")
...
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Plot_cdr2_astro.jpeg", width=6, height=4, units="in", res=300)
...
cond = relevel(cond, 'early-pathology')
...
write.csv(results_by_padj_astro_late,"./results/results_by_padj_20_astroAD_late_vs_early.csv")
write.csv(results_by_absFC_astro_late,"./results/results_by_absFC_20_astroAD_late_vs_early.csv")
...
library(ggrepel)
# volcano plot
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Volcano_Plot_astro_late.jpeg", width=6, height=4, units="in", res=300)
ggplot(results_astro_late) +
  ...
  ggtitle("Volcano plot - AD Astrocytes Early vs. Late AD") +
...
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Plot_cdr2_neu.jpeg", width=6, height=4, units="in", res=300)
...
write.csv(results_by_padj_neu_late,"./results/results_by_padj_20_neuAD_late_vs_early.csv")
write.csv(results_by_absFC_neu_late,"./results/results_by_absFC_20_neuAD_late_vs_early.csv")
...
library(ggrepel)
# volcano plot
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Volcano_Plot_neu_late.jpeg", width=6, height=4, units="in", res=300)
...
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Plot_cdr2_endo.jpeg", width=6, height=4, units="in", res=300)
...
library(ggrepel)
# volcano plot
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Volcano_Plot_endo_late.jpeg", width=6, height=4, units="in", res=300)
...
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Plot_cdr2_micro.jpeg", width=6, height=4, units="in", res=300)
...
library(ggrepel)
# volcano plot
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Volcano_Plot_micro_late.jpeg", width=6, height=4, units="in", res=300)
...
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Plot_cdr2_oligo.jpeg", width=6, height=4, units="in", res=300)
...
library(ggrepel)
# volcano plot
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Volcano_Plot_oligo_late.jpeg", width=6, height=4, units="in", res=300)
...
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Plot_cdr2_oligoPC.jpeg", width=6, height=4, units="in", res=300)
...
library(ggrepel)
# volcano plot
jpeg(file="./figures/7.Differential Expression_20_celltypes_early_vs_late/Volcano_Plot_oligoPC_late.jpeg", width=6, height=4, units="in", res=300)
